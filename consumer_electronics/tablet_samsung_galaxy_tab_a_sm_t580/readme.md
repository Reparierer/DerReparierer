...
A quick internet search shows that this is a [typical mistake](https://www.youtube.com/watch?v=Y3uDwV5y9XM). The cable from the charging socket to the mainboard was apparently too short. Over the course of daily use, it can happen that this connecting cable slips out of the plug on the mainboard. In most cases, the cable has only slipped out half a millimeter. This is enough for the device to stop working.
