...
The fault description sounds typical for dirty potentiometers.  To clean them, isopropanol is sprayed into an opening of the potentiometer and then the potentiometer is moved around generously. This softens the dirt on the running surface of the potentiometer and pushes it away so that contact is made again. Be aware, the dirt is still in the potentiometer, and has only been moved away from the contact path. 
